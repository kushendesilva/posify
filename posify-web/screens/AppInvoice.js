...
import { Button, CheckBox, Icon } from "@ui-kitten/components";
...
function AppInvoice({ route, navigation }) {
  ...
  const PrintIcon = (props) => <Icon {...props} name="printer" />;
      ...
      <ScrollView style={{ backgroundColor: "#222b45" }}>
        ...
        <View style={{ paddingBottom: "5%" }}>
          ...
          {AppRenderIf(
            ...
            >
              Printed using Posify Web Application
            </Button>
          )}
        </View>
        <Portal>
